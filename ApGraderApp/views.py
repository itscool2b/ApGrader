...
def create_pdf(prompt, response_text):
    ...
    template = PageTemplate(id="template", frames=[frame], onPage=add_page_number)
    ...
    content.append(Paragraph("LEQ Grading Report", heading_style))
    content.append(Spacer(1, 20))  

    
    content.append(Paragraph("<b>Prompt:</b>", section_heading_style))
    content.append(Paragraph(prompt, body_style))
    content.append(Spacer(1, 20)) 

    
    content.append(Paragraph("<b>Response:</b>", section_heading_style))
    for line in response_text.split("\n"):
        content.append(Paragraph(line, body_style))

    
    footer_text = "Generated by LEQ Grading System"
