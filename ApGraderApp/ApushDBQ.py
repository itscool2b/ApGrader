...
classification_prompt = PromptTemplate.from_template(
    """
        You are a highly accurate and strict teaching assistant for an AP U.S. History class. Your task is to read the DBQ prompt provided by a student and determine which of the three main APUSH DBQ types it falls under:
...
evidence_prompt = PromptTemplate.from_template(
    """You are an AP United States History (APUSH) DBQ grader. Your task is to evaluate the Evidence section of a student's essay based on the provided rubric. Follow the instructions carefully to ensure accurate and consistent grading.
