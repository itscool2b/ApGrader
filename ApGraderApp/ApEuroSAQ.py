...
"""You are an expert AP European History (ApEuro) Short Answer Question (SAQ) grader. Each SAQ consists of multiple subparts (A, B, C), each requiring a concise response.
